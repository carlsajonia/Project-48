...
function preload(){
  ...
  killingsound=loadSound("Sound Effect Glock 17.mp3");
}
function setup(){
...
function draw(){
  ...
  if(gamestate===serve){
   ...
   textSize(10);
   fill("cyan");
   text("YOU HAVE ONLY 1 LIFE TRY TO SURVIVE FOR LONG.PRESS SPACE TO JUMP AND K TO SHOOT.PRESS R TO PLAY.",10,300);
   if(keyDown("r")){
     gamestate=play;
   }
...
function createbullet(){
  bullet=createSprite(80,75,20,20);
  bullet.scale=0.02;
  bullet.velocityX=3;
